  ...
  return (
    <div className="hero-section bg-indigo-900 bg-opacity-50 text-white h-screen flex flex-col justify-center items-center absolute inset-0">
      <div className="max-w-screen-lg mx-auto px-4">
        ...
        <a href={email}>
          <button className="mt-2 bg-indigo-500 hover:bg-indigo-700 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline"
          >
            Send me an email
          </button>
        </a>
        ...
        <div className="container flex m-2">
          <span>Folow me on instagram</span>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-5 w-5 mx-2 text-violet-600"
            fill="currentColor"
            viewBox="0 0 24 24">
            <path

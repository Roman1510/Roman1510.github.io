...
const linkedInLink = import.meta.env.VITE_LINKEDINLINK
const overflowLink = import.meta.env.VITE_STACKOVERFLOWLINK
    ...
    <div className="hero-section bg-indigo-900 bg-opacity-50 text-white h-screen flex flex-col justify-center items-center absolute inset-0">
      <div className="container-margin max-w-screen-lg mx-auto px-4">
        <p className="text-white text-lg text-center cursor-default">
          Please get in touch with me through these platforms:
        </p>
        <div className="grid grid-cols-3 gap-20 mt-8">
          <a href={`${githubLink}`} target="_blank">
            ...
            >
              <h2 className="text-indigo-900 text-xl font-semibold mb-2">Github</h2>
          ...
          <a href={`${linkedInLink}`} target="_blank">
            ...
            >
              <h2 className="text-indigo-900 text-xl font-semibold mb-2">LinkedIn</h2>
          ...
          <a href={`${overflowLink}`} target="_blank">
            <div
            ...
            >
              <h2 className="text-indigo-900 text-sm font-semibold mb-2">StackOverflow</h2>
              <div className="text-indigo-500 flex items-center justify-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-10 w-10"
          ...
          <a href={`${twitterLink}`} target="_blank">
            <div
              ...
              className="bg-yellow-300 rounded-lg p-4 text-center transition-transform transform cursor-pointer"
              onMouseEnter={() => handleHover(squaresRef.current[3]!)}
              onMouseLeave={() => handleHoverEnd(squaresRef.current[3]!)}
            >
              <h2 className="text-indigo-900 text-xl font-semibold mb-2">Twitter</h2>
              <div className="text-indigo-500 flex items-center justify-center">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-10 w-10"
          ...
          <div className="m-3 content-center justify-center">
            <p className=" text-white text-lg text-center cursor-default">
              ...or you can just
            </p>
            <a href={`mailto:${email}`}>
              <button className="m-3  bg-indigo-500 hover:bg-indigo-700 text-white py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                Email me
              </button>
            </a>
          </div>
